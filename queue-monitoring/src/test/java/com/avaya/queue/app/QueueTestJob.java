...
//			List<SR> queueList = siebelReportDownloader.getQueueList(Constants.QUEUE_FILE_NAME);
	...
	private void setSRCustomerContractsDb(SR sr) {
		...
		customerContractDao = (CustomerContractDao) QueueMonitoringTestApp.context.getBean("customerContractDao");
	...
	public void processEmailToSend(List<SR> queueList) {
		...
		NotificationDao noticiationDao = (NotificationDao) QueueMonitoringTestApp.context.getBean("notificationDao");
